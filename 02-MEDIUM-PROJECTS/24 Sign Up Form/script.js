document.querySelector('.banner-btn').addEventListener('click', () => {
    ...
    document.querySelector('.container').style.background = 'orangered'    
})
document.querySelector('.x-btn').addEventListener('click', () => {
    ...
    document.querySelector('.container').style.cssText = 'background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.7)), url(alexander - grey - WqPAETBU2G8 - unsplash.jpg) center no-repeat; background-size = cover';    
})